...
// First login attempt - it's always not success
        readUntil("Login id:");
        write("");
        readUntil("Password:");
        write("");
// second login attempt - should be success
        readUntil("Login id:");
        write(login);
        readUntil("Password:");
        write(password);
...
//    cleanup inbox for user Username
    ...
    private void closeFolder(Folder folder) throws MessagingException {
        folder.close(true); //delete all mails marked as Deleted
        store.close();
    }
